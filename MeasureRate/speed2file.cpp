        ...
        packet)
{
	...
	*/
    ...
    if(tv.tv_sec*1000 + tv.tv_usec/1000 >= nxt_end){
	double ratio = 1.0*tot_ippkt_len/(interval)*8/1000;
	...
	//tot_ippkt_len += 1500;
	tot_ippkt_len += (len-PACKET_HEADER);
	tot_packet++;
	//printf("%d\n", len);
	//printf("%d\n", tot_packet);
    return NULL;
...
int main(int argc,char **argv)
{
   ...
   //freopen("speed_data.txt", "w", stdout);
   	p = fopen("/root/speed_data.txt", "w");
	char *dev;
